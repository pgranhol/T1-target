...
void DetectorConstruction::DefineMaterials()
{
 ...
 //New Helium cooling, mostly for the inert atmosphere. No actual cooling.
  ...
  G4Material* Helium = new G4Material(name="Helium", density, nel=1, kStateGas, temperature, pressure);
  Helium->AddMaterial(He, fractionmass=1);
